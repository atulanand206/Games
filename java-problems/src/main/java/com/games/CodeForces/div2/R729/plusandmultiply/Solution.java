package com.games.CodeForces.div2.R729.plusandmultiply;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            long[] sp = I.inputLongArray(br);
            long n = sp[0], a = sp[1], b = sp[2];
            if (b == 1) {
                sb.append("Yes\n");
                continue;
            }
            ...
            q1.add(1L);
            boolean flag = false;
            while (!q1.isEmpty() && q1.peek() < n && q1.peek() < Integer.MAX_VALUE) {
                long x = q1.poll();
                if (x * a == n || x + b == n) {
                    sb.append("Yes\n");
                    flag = true;
                ...
                if (a != 1 && !q1.contains(x * a) && x * a < n) q1.add(x * a);
                if (!q1.contains(x + b) && x + b < n) q1.add(x + b);
            }
