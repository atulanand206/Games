package com.games.CodeForces.div3.R731.B;
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            while (st >= 0 || en < n) {
                ...
                int currP = (int)(chs[st]);
                int currN = (int)(chs[en]);
                int prev = st - 1 >= 0 ? (int)(chs[st - 1]) : 0;
                int next = en + 1 < n ? (int)(chs[en + 1]) : 0;
                if (st - 1 >= 0 && prev == currP + 1) {
                    st--;
                    currP = currP + 1;
                    cnt++;
                    continue;
                } 
                if (en + 1 < n && next == currP + 1) {
                    en++;
                    currN = currP + 1;
                    cnt++;
                    continue;
                }
                if (st - 1 >= 0 && prev == currN + 1) {
                    st--;
                    currP = currN + 1;
                    cnt++;
                    continue;
                }
                if (en + 1 < n && next == currN + 1) {
                    en++;
                    currN = currN + 1;
                    cnt++;
                    continue;
