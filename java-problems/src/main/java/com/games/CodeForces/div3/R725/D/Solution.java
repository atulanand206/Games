package com.games.CodeForces.div3.R725.D;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            int a = spec[0], b = spec[1], k = spec[2];
            Map<Integer, Integer> aF = factorize(a);
            Map<Integer, Integer> bF = factorize(b);
            Map<Integer, Integer> gF = factorize(gcd(a, b));
            int as = factorCount(aF);
            int bs = factorCount(bF);
            int maxPos = 0;
            if (as != bs) maxPos = Math.max(as, bs) - Math.min(as, bs);
            as = Math.min(as, bs);
            boolean flag = false;
    ...
    static Map<Integer, Integer> factorize(long n) {
    ...
    private static int factorCount(Map<Integer, Integer> aF) {
        int as = 0;
        for (int i : aF.values()) as += i;
        return as;
    }
