package com.games.CodeForces.square;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int t = I.inputInt(br);
        while (t-- > 0) {
            int[] p1 = I.inputIntArray(br);
            int[] p2 = I.inputIntArray(br);
            if (p1[0] == p2[0] && p1[1] + p2[1] == p1[0]) {
                O.print("Yes\n");
                continue;
            }
            if (p1[0] == p2[1] && p1[1] + p2[0] == p1[0]) {
                O.print("Yes\n");
                continue;
            }
            if (p1[1] == p2[0] && p1[0] + p2[1] == p1[1]) {
                O.print("Yes\n");
                continue;
            }
            if (p1[1] == p2[1] && p1[0] + p2[0] == p1[1]) {
                O.print("Yes\n");
                continue;
            }
            O.print("No\n");
