package com.games.CodeForces.divanStore;
...
public class Solution {
    ...
    private static int spendings(int[] arr, int l, int r, int k) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (n-- > 0) {
            int[] specs = I.inputIntArray(br);
            int[] arr = I.inputIntArray(br);
            sb.append(spendings(arr, specs[1], specs[2], specs[3])).append("\n");
        }
        O.print(sb.toString());
    }
