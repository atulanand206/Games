package com.games.CodeForces.fairPlayOff;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            ...
            int m1 = Math.max(spec[0], spec[1]);
            int m2 = Math.max(spec[2], spec[3]);
            Arrays.sort(spec);
            int[] finalPair = new int[]{m1, m2};
            Arrays.sort(finalPair);
            if (finalPair[0] == spec[2] && finalPair[1] == spec[3]) System.out.println("YES");
