package com.games.CodeForces.generatelogin;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        O.attach();
        String[] name = I.inputString(br).split(" ");
        char[] s = name[0].toCharArray();
        char[] e = name[1].toCharArray();
