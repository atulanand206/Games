package com.games.CodeForces.alexandbrokencontest;
...
public class Solution {
  ...
  private static final String[] friends = new String[] {"Danil", "Olya", "Slava", "Ann", "Nikita"};
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (String friend : friends) {
          if (s.contains(friend)) {
            if (s.indexOf(friend) != s.lastIndexOf(friend))  {
              O.print("NO");
              return;
            } else f++;
          }
