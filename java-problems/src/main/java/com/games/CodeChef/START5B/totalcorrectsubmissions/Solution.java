package com.games.CodeChef.START5B.totalcorrectsubmissions;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (t-- > 0) {
            int x = 3 * I.inputInt(br);
            Map<String, Integer> map = new HashMap<>();
            while (x-- > 0) {
                String[] spec = I.inputStringArray(br);
                map.merge(spec[0], Integer.parseInt(spec[1]), Integer::sum);
            }
