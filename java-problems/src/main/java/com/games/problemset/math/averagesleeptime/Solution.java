package com.games.problemset.math.averagesleeptime;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        sum = 0;
        for (double d : game) sum += d;
        sum = sum / game.length;
        sb.append(String.format("%.7f", sum));
        O.debug(S.string(game));
        O.print(sb);
    }
