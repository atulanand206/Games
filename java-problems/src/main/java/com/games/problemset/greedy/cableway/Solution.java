package com.games.problemset.greedy.cableway;
...
public class Solution {
    ...
    public static void main(String[] args) throws IOException {
        ...
        int r = (int)Math.ceil((double)spec[0] / 2) - 1,
        g = (int)Math.ceil((double)spec[1] / 2) - 1, 
        b = (int)Math.ceil((double)spec[2] / 2) - 1;
        O.debug(String.format("%d %d %d\n", r, g, b));
        r = 0 + r * 3;
        g = 1 + g * 3;
        b = 2 + b * 3;
        O.debug(String.format("%d %d %d\n", r, g, b));
        int s = Math.max(r, Math.max(g, b));
        sb.append(s + 30);
        O.print(sb);
    }
